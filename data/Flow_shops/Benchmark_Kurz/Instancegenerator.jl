...
using Distributions
using StatsBase
# read instances from Kurz

##############################################################
# Helper functions
"""
    distribution(type::String,mean::Float64, ratiominmean::Float64, ratiomaxmean::Flaot64) -> Dict()    
    Dict includes:
...
# generateInstance(distributiontype = "Deterministic", case = "ii", ratiominmean = 0.5)


generateInstance(case = "ii", ratiominmean = 0.5)
